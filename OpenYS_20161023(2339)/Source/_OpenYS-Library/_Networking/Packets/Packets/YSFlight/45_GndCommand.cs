...
namespace OpenYS
{
    ...
    {
        public class Packet_45_GndCommand : GenericPacket
        {
            /// <summary>
            ...
            public Packet_45_GndCommand(GenericPacket DataPacket)
            ...
            public Packet_45_GndCommand(uint _ID, string _Command, string _Argument)
                : base() //base == parent. ie: create the parent with this argument.
            {
                base.Type = 45;
