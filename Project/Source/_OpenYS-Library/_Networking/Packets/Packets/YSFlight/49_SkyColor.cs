...
namespace OpenYS
{
    ...
    {
        public class Packet_49_SkyColor : GenericPacket
        {
            /// <summary>
            ...
            public Packet_49_SkyColor(GenericPacket DataPacket)
            ...
            public Packet_49_SkyColor(byte _Red, byte _Green, byte _Blue)
                : base() //base == parent. ie: create the parent with this argument.
            {
                base.Type = 49;
            ...
            public Packet_49_SkyColor(Colors.XRGBColor _Color)
            {
                base.Type = 49;
                base.Data = new byte[0];
                Red = _Color.Red;
