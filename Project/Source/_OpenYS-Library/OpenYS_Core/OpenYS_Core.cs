        ...
        public static Packets.Packet_33_Weather _Weather
        {
            get
            {
                ...
                Packets.Packet_33_Weather WeatherPacket = new Packets.Packet_33_Weather(false)
                {
                    ...
                    UNKNOWN = Settings.Options.Control.Unknown, //No idea... You don't have to enable this but it doesn't appear to make a difference.
            ...
            set
            {
                ...
                Settings.Options.Control.Unknown = value.UNKNOWN;
