...
namespace OpenYS
{
    public static class Console
    {
        ...
        private static void _DummyCommandProcessor(object Message, params object[] Args)
        {
            Debug.WriteLine("No CommandProcessor Set for Console...");
        }
        private static void _DummyOutputLogger(string Input)
        {
            Debug.WriteLine("No OutputLogger Set for Console...");
        }
        #endregion

        #region Delegates
        public delegate void _CommandProcessor(object Message, params object[] Args); //ConsoleInput -> CommandProcessor
        public static _CommandProcessor CommandProcessor = _DummyCommandProcessor;
        public delegate void _OutputLogger(object Message, params object[] Args); //Anylocation -> ConsoleOutput.
        public static List<_OutputLogger> OutputLoggers = new List<_OutputLogger>();
        #endregion
        ...
        public static _CommandProcessor _Process = _DummyCommandProcessor;
        ...
        {
            foreach (_OutputLogger ThisLogger in OutputLoggers)
            {
                ThisLogger(message);
            }
            if (!console_present) return;
